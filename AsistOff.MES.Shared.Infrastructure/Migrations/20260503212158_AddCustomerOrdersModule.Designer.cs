...
namespace AsistOff.MES.Shared.Infrastructure.Migrations
{
    ...
    [Migration("20260503212158_AddCustomerOrdersModule")]
    partial class AddCustomerOrdersModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AsistOff.MES.CustomerOrders.Domain.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Customers", "customer_orders");
                });

            modelBuilder.Entity("AsistOff.MES.CustomerOrders.Domain.Entities.CustomerOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ExternalSystem", "ExternalOrderId")
                        .IsUnique();

                    b.ToTable("CustomerOrders", "customer_orders");
                });

            modelBuilder.Entity("AsistOff.MES.CustomerOrders.Domain.Entities.CustomerOrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("MeasureUnitCodeSnapshot")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.ToTable("CustomerOrderLines", "customer_orders");
                });

            modelBuilder.Entity("AsistOff.MES.CustomerOrders.Domain.Entities.CustomerOrderLineProductionRelease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "CustomerOrderLineId");

                    b.HasIndex("TenantId", "RecipeId");

                    b.ToTable("CustomerOrderLineProductionReleases", "customer_orders");
                });
            ...
            modelBuilder.Entity("AsistOff.MES.CustomerOrders.Domain.Entities.CustomerOrder", b =>
                {
                    b.HasOne("AsistOff.MES.CustomerOrders.Domain.Entities.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("AsistOff.MES.CustomerOrders.Domain.Entities.CustomerOrderLine", b =>
                {
                    b.HasOne("AsistOff.MES.CustomerOrders.Domain.Entities.CustomerOrder", "CustomerOrder")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("AsistOff.MES.CustomerOrders.Domain.Entities.CustomerOrderLineProductionRelease", b =>
                {
                    b.HasOne("AsistOff.MES.CustomerOrders.Domain.Entities.CustomerOrderLine", "CustomerOrderLine")
                        .WithMany("ProductionReleases")
            ...
            modelBuilder.Entity("AsistOff.MES.CustomerOrders.Domain.Entities.CustomerOrderLine", b =>
                {
                    b.Navigation("ProductionReleases");
                });
