...
const pl = {
  ...
  customers: {
    title: 'Kontrahenci',
    subtitle: 'Kartoteka klientów używanych w zamówieniach',
    create: 'Nowy kontrahent',
    code: 'Kod',
    name: 'Nazwa',
    taxId: 'NIP',
    email: 'E-mail',
    ...
    city: 'Miasto',
    country: 'Kraj',
    filters: { code: 'Kod zawiera…', name: 'Nazwa zawiera…', taxId: 'NIP zawiera…' }
  },
  customerOrders: {
    title: 'Zamówienia klientów',
    subtitle: 'Popyt klienta importowany z ERP lub wprowadzany ręcznie',
    detailTitle: 'Zamówienie klienta',
    create: 'Nowe zamówienie',
    orderNumber: 'Numer zamówienia',
    customer: 'Kontrahent',
    customerPlaceholder: 'Wybierz kontrahenta…',
    orderDate: 'Data zamówienia',
    requestedDeliveryDate: 'Termin dostawy',
    confirmedDeliveryDate: 'Potwierdzony termin',
    externalSystem: 'System źródłowy',
    externalOrderId: 'ID w systemie źródłowym',
    currency: 'Waluta',
    notes: 'Uwagi',
    lines: 'Pozycje',
    line: 'Pozycja',
    ...
    releaseProgress: 'Przekazano do produkcji',
    addLine: 'Dodaj pozycję',
    releaseToProduction: 'Generuj zlecenie',
    productionReleases: 'Planowane zlecenia produkcyjne',
    recipe: 'Receptura',
    recipePlaceholder: 'Wybierz wydaną recepturę…',
    plannedStartDate: 'Planowany start',
    plannedDueDate: 'Planowany termin',
    releaseCreated: 'Pozycja przekazana do produkcji',
    filters: { orderNumber: 'Numer zawiera…', customer: 'Kontrahent zawiera…', status: 'Status' },
    status: { 1: 'Zaimportowane', 2: 'Potwierdzone', 3: 'Częściowo przekazane', 4: 'Przekazane do produkcji', 5: 'Zakończone', 6: 'Anulowane' },
    lineStatus: { 1: 'Otwarte', 2: 'Częściowo przekazane', 3: 'Przekazane do produkcji', 4: 'Zakończone', 5: 'Anulowane' },
    productionReleaseStatus: { 1: 'Zaplanowane', 2: 'Utworzono zlecenie', 3: 'Anulowane' }
  },
  scanBy: { 1: 'EAN', 2: 'Kod' },
  stubs: {
...
const en: typeof pl = {
  ...
  customers: {
    title: 'Customers',
    subtitle: 'Customer master data used in sales demand',
    create: 'New customer',
    code: 'Code',
    name: 'Name',
    taxId: 'Tax ID',
    ...
    city: 'City',
    country: 'Country',
    filters: { code: 'Code contains…', name: 'Name contains…', taxId: 'Tax ID contains…' }
  },
  customerOrders: {
    title: 'Customer orders',
    subtitle: 'Customer demand imported from ERP or entered manually',
    detailTitle: 'Customer order',
    create: 'New order',
    ...
    quantity: 'Quantity',
    unitNetPrice: 'Net unit price',
    releaseProgress: 'Released to production',
    addLine: 'Add line',
    releaseToProduction: 'Generate order',
    productionReleases: 'Planned production orders',
    recipe: 'Recipe',
    recipePlaceholder: 'Select released recipe…',
    plannedStartDate: 'Planned start',
    plannedDueDate: 'Planned due date',
    releaseCreated: 'Line released to production',
    filters: { orderNumber: 'Number contains…', customer: 'Customer contains…', status: 'Status' },
    status: { 1: 'Imported', 2: 'Confirmed', 3: 'Partially released', 4: 'Released to production', 5: 'Completed', 6: 'Cancelled' },
    lineStatus: { 1: 'Open', 2: 'Partially released', 3: 'Released to production', 4: 'Completed', 5: 'Cancelled' },
    productionReleaseStatus: { 1: 'Planned', 2: 'Production order created', 3: 'Cancelled' }
  },
  scanBy: { 1: 'EAN', 2: 'Code' },
  stubs: {
