...
public static class AuthorizationAllowlist
{
    ...
    public static readonly IReadOnlySet<string> AllowedRequestFullNames =
        new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "AsistOff.MES.Configuration.Application.Features.MaintenancePlans.Due.GetDueMaintenancePlansRequest",
            ...
            "AsistOff.MES.Production.Application.Features.ShiftHandovers.Browse.BrowseShiftHandoversRequest",
            "AsistOff.MES.Production.Application.Features.ShiftHandovers.Get.GetShiftHandoverByIdRequest",
