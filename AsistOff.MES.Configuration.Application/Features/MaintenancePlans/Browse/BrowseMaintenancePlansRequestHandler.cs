...
internal sealed class BrowseMaintenancePlansRequestHandler(IMaintenancePlansRepository repository)
    : IRequestHandler<BrowseMaintenancePlansRequest, PagedResponse<MaintenancePlanResponse>>
{
    ...
    internal static MaintenancePlanResponse Map(MaintenancePlan p) => new(
