...
{
    public async Task<IReadOnlyCollection<Shift>> BrowseAsync(
        Paginator<Shift> paginator, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<int> CountAsync(
        ExpressionStarter<Shift> predicate, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<IReadOnlyCollection<Shift>> GetByIdsAsync(
    ...
    {
        var query = context.Set<Shift>().Where(x => x.Code == code);
